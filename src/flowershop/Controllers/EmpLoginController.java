...
public class EmpLoginController implements Initializable {
    ...
    private void handleButtonAction(ActionEvent event) throws SQLException {
        try {
            ...
            pst = con.prepareStatement("select uname,pword from emplogin where uname = ? and pword = ?");
            ...
            Logger.getLogger(EmpLoginController.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    public void getEmployeeidFromDatabase() throws SQLException{
        pst = con.prepareStatement("select emploginid from emplogin where uname = ? and pword = ?");
            String uname = t_username.getText();
            String pword = t_password.getText();
            pst.setString(1,uname);
            pst.setString(2,pword);
    ...
    public void toEmployeeDashboard() throws SQLException{
        getEmployeeidFromDatabase();
