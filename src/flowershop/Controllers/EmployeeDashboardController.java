...
public class EmployeeDashboardController implements Initializable {
    ...
    public void setLoginid(int loginid) {
       ...
       // System.out.println("in empdashh: "+getLoginid());
    }
    ...
    public void toProfileScreen(){
        ...
        loader.setLocation(getClass().getResource("/flowershop/EmployeePath/Profile.fxml"));
        try{
        ...
        ProfileController e = loader.getController();
